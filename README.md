...
**SimpleIG** is an android app that allows a user to check out popular photos from Instagram. The app utilizes Instagram API to display images and basic image information to the user.
...
<img src='https://imageshack.us/a/img910/3180/787mx7.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
